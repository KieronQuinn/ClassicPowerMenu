...
import com.android.systemui.util.annotations.DeviceType
...
) : RecyclerView.Adapter<Holder>(), KoinComponent {
                ...
                ControlHolder(
                    layoutInflater.inflate(R.layout.controls_base_item, parent, false).apply {
                        ...
                        background = parent.context.getDrawable(
                                R.drawable.control_background_ripple)?.apply {
                            setTint(monet.getPrimaryColor(context, true))
                        }
                    },
 ...
 */
private class ZoneHolder(view: View) : Holder(view), KoinComponent {
    private val zone: TextView = itemView as TextView
    private val monet by inject<MonetColorProvider>()

    override fun bindData(wrapper: ElementWrapper) {
        wrapper as ZoneNameWrapper
        monet.applyMonetToView(zone, true)
...
internal class ControlHolder(
    ...
    private val title: TextView = itemView.requireViewById<TextView>(R.id.title).apply {
        monet.applyMonetToView(this, true)
    }
    private val subtitle: TextView = itemView.requireViewById<TextView>(R.id.subtitle).apply {
        monet.applyMonetToView(this, true)
    }
