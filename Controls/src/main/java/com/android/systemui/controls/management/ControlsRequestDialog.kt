...
import com.android.systemui.util.extensions.ControlsProviderService_EXTRA_CONTROL
import com.android.systemui.util.extensions.Intent_EXTRA_USER_ID
import com.android.systemui.util.extensions.UserHandle_USER_NULL
import org.koin.android.ext.android.inject

open class ControlsRequestDialog: LifecycleActivity(), DialogInterface.OnClickListener, DialogInterface.OnCancelListener {

    private val controller by inject<ControlsController>()
    private val broadcastDispatcher by inject<BroadcastDispatcher>()
    private val controlsListingController by inject<ControlsListingController>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val requestUser = intent.getIntExtra(Intent_EXTRA_USER_ID, UserHandle_USER_NULL)
        ...
        control = intent.getParcelableExtra(ControlsProviderService_EXTRA_CONTROL) ?: run {
    ...
    fun createDialog(label: CharSequence): Dialog {
        ...
        //TODO SystemUIDialog.registerDismissListener(dialog)
