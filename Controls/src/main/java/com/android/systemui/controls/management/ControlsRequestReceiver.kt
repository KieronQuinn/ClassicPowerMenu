...
import com.android.systemui.util.extensions.getUidImportance
import com.android.systemui.util.extensions.userId
...
class ControlsRequestReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val activityIntent = Intent(context, ControlsRequestDialog::class.java).apply {
            ...
            ControlsProviderService_EXTRA_CONTROL.let {
                putExtra(it, intent.getParcelableExtra<Control>(it))
            }
            addFlags(Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_REORDER_TO_FRONT)
        }
        activityIntent.putExtra(Intent_EXTRA_USER_ID, context.userId)
