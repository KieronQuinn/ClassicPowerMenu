...
import com.android.systemui.util.extensions.ControlTemplate_NO_TEMPLATE
...
class ControlViewHolder(
    ...
    companion object {
        ...
        fun findBehaviorClass(
            ...
            return when {
                ...
                template == ControlTemplate_NO_TEMPLATE -> TouchBehavior::class
    ...
    val controlTemplate: ControlTemplate
        get() = cws.control?.let { it.controlTemplate } ?: ControlTemplate_NO_TEMPLATE
    ...
    fun actionResponse(@ResponseResult response: Int) {
    ...
    fun usePanel(): Boolean {
        return deviceType in ControlViewHolder.FORCE_PANEL_DEVICES ||
            controlTemplate == ControlTemplate_NO_TEMPLATE
    }
    ...
    private fun animateBackgroundChange(
        ...
        val bg = monet.getPrimaryColor(context, true) //context.resources.getColor(R.color.control_default_background, context.theme)
