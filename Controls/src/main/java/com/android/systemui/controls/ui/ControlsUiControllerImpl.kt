...
import com.android.systemui.util.extensions.dismissImmediate
import com.android.systemui.util.extensions.get
...
class ControlsUiControllerImpl constructor (
...
) : ControlsUiController, KoinComponent {
