...
data class RenderInfo(
    ...
    companion object: KoinComponent {
        ...
        fun lookup(
            ...
            val (fg, bg) = getDeviceColorMap(monet.getPrimaryColor(context, true)).getValue(key)
...
private fun getDeviceColorMap(defaultColor: Int) = mapOf<Int, Pair<Int, Int>>(
    (THERMOSTAT_RANGE + TemperatureControlTemplate.MODE_OFF) to
            Pair(R.color.control_default_foreground, defaultColor),
